...
const CategoryDetail = () => {
  ...
  if (!category) {
    return (
      <div className="category-detail-page container fade-in">
        <p className="loading-text">Catégorie non trouvée.</p>
      </div>
    );
  }
    ...
    <div className="category-detail-page container fade-in">
      <div className="cat-header">
        <div className="breadcrumbs">
          Accueil &gt; Catégories &gt; {category.title}
        </div>
      ...
      <div className="partners-banner">
        <div className="partners-header">
          ...
          <div className="partners-title-row">
            <h2>
              Nos Marques <span className="highlight-text">Partenaires</span>
            </h2>
            <a href="#" className="view-all-partners">
