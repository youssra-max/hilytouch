...
const BlogArticle = () => {
  ...
  if (loading) return <div className="article-page container fade-in"><p className="loading-text">Chargement...</p></div>;
  if (!article) return <div className="article-page container fade-in"><p className="loading-text">Article non trouvé.</p></div>;
  ...
  return (
    <div className="article-page fade-in">
      ...
      <div className="container">
        <Link href="/blog" className="back-link"><ArrowLeft size={16} /> Retour au blog</Link>
        <article className="article-content">
          ...
          <div className="article-meta">
            ...
            <span><Clock size={14} /> {article.readTime} de lecture</span>
          </div>
