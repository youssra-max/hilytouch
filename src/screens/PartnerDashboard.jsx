...
import { Plus, Package, Trash2, Edit3, Image as ImageIcon, Check, AlertCircle, X } from 'lucide-react';
import { fetchPartnerProducts, addPartnerProduct, deletePartnerProduct, fetchCategories, isAuthenticated } from '../lib/api';
...
const PartnerDashboard = () => {
  ...
  if (loading && products.length === 0) {
    return <div className="partner-loading container"><div className="loader"></div></div>;
  }
  ...
  return (
    <div className="partner-dashboard container fade-in">
      ...
      {success && <div className="alert-success-fixed"><Check size={18} /> {success}</div>}
      ...
      <div className="pd-stats">
        ...
        <div className="pd-stat-card">
          ...
          <span className="value">{products.reduce((acc, p) => acc + p.stock, 0)}</span>
        </div>
      </div>
      ...
      <div className="pd-products-list">
        ...
        {products.length === 0 ? (
          <div className="pd-empty">
            ...
            <button className="btn btn-outline" onClick={() => setShowAddModal(true)}>Ajouter mon premier produit</button>
          </div>
        ) : (
            ...
            <form onSubmit={handleSubmit} className="pd-form">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input 
                    type="text" required placeholder="Ex: Crème Hydratante"
                ...
                <div className="form-group">
                  <label>Marque</label>
                  <input 
                    type="text" required placeholder="Votre marque"
              ...
              <div className="form-row">
                ...
                <div className="form-group half">
                  <label>Prix (DA)</label>
                  <input 
                    type="number" required placeholder="6500"
              ...
              <div className="form-group">
                ...
                <textarea 
                  required placeholder="Décrivez les propriétés de votre produit..."
