...
const Dashboard = () => {
  ...
  const mockOrders = [
    {
      ...
      date: "11/04/2026",
      total: "15 400 DZD",
      items: "Sérum Anti-Âge, Crème Nuit",
      status: "preparation",
    },
    {
      id: "CMD-1902",
      date: "28/03/2026",
      total: "4 200 DZD",
      items: "Huile Scintillante Corps",
      status: "livree",
    },
  ];
  ...
  const mockAddresses = [
    {
      ...
      phone: "0555 12 34 56",
      wilaya: "16 - Alger",
      address: "Résidence Chaabani, Bâtiment C",
    },
    {
      id: 2,
      title: "Bureau",
      ...
      phone: "0770 98 76 54",
      wilaya: "31 - Oran",
      address: "Rue Larbi Ben M'hidi, 2ème étage",
    },
  ];
  ...
  const getStatusDisplay = (status) => {
    switch (status) {
      case "preparation":
        return { label: "En préparation", class: "status-warning" };
      case "expediee":
        return { label: "Expédiée", class: "status-info" };
      case "livree":
        return { label: "Livrée", class: "status-success" };
      default:
  ...
  const renderOrders = () => (
    <div className="customer-tab fade-in">
      ...
      <p className="sub-text">
        Consultez l'historique et le statut en temps réel de vos achats.
      </p>
          ...
          return (
            <div key={order.id} className="customer-order-card">
              <div className="order-header">
                ...
                <span className={`order-badge ${status.class}`}>
                  {status.label}
                </span>
              </div>
              <div className="order-body">
                <p>
                  <strong>Articles :</strong> {order.items}
                </p>
  ...
  const renderWishlist = () => (
    <div className="customer-tab fade-in">
      ...
      <p className="sub-text">
        Vos produits coup de cœur mis de côté pour vos prochains achats.
      </p>
        ...
        {mockWishlist.map((item) => (
          <div key={item.id} className="wishlist-card">
            ...
            <div className="wishlist-info">
              ...
              <button className="btn-primary outline full-width mt-1">
                Ajouter au panier
              </button>
            </div>
          </div>
