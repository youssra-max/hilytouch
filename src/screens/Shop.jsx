...
const Shop = () => {
  ...
  const activeFilter = searchParams
    ...
    <div className="shop-page container fade-in">
      <div className="shop-header">
        ...
        <p className="page-desc">
          Découvrez notre collection exclusive de soins algériens, formulés pour
          magnifier votre éclat.
        </p>
      </div>
      ...
      <div
        className={`shop-content-wrapper ${!isSidebarOpen ? "sidebar-closed" : ""}`}
      ...
      >
        ...
        <div
          className={activeBrand ? "shop-full-grid" : "shop-brands-container"}
          style={{ flex: 1 }}
        >
          {loading ? (
            ...
            <div className="brand-detail-view">
              <div className="brand-detail-header">
                ...
                <p className="brand-subtitle">
                  Découvrez toute la gamme disponible
                </p>
      ...
      >
        <div className="newsletter-content">
          ...
          <p>
            Inscrivez-vous pour recevoir nos conseils beauté et des offres
            exclusives.
          </p>
        </div>
        <div
