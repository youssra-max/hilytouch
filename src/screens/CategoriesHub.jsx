    ...
    <div className="categories-hub container fade-in">
      <div className="hub-header text-center">
        ...
        <p className="page-desc mx-auto">
          Découvrez une sélection rigoureuse de soins d'exception, alliant
          rituels ancestraux et innovation technologique pour magnifier votre
          éclat naturel.
        </p>
      </div>
      ...
      <div className="secret-garden-banner">
        <div className="secret-garden-content">
          ...
          <p>
            Chaque produit de notre collection est une ode à la nature. Nous
            privilégions les extraits botaniques sourcés avec éthique pour créer
            une harmonie parfaite entre votre peau et l'environnement.
          </p>
        ...
        <div className="secret-garden-images">
          <img
            src="https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?q=80&w=2074&auto=format&fit=crop"
            alt="Nature"
            className="sg-img-1"
          />
          <img
            src="https://images.unsplash.com/photo-1560706834-0d92e59265f9?q=80&w=1974&auto=format&fit=crop"
            alt="Fleur"
            className="sg-img-2"
          />
        </div>
