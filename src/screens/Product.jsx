...
const Product = () => {
  ...
  if (!product) {
    return (
      <div className="product-detail-page container fade-in">
        <p className="loading-text">Produit non trouvé.</p>
      </div>
    );
  }
      ...
      <div className="product-main">
        ...
        <div className="product-info-panel">
          ...
          <div className="product-perks">
            <div className="perk">
              <Leaf size={20} /> <p>100% Naturel</p>
            </div>
            <div className="perk">
              <ShieldCheck size={20} /> <p>Testé dermatologiquement</p>
            </div>
            <div className="perk">
              <Heart size={20} /> <p>Cruelty Free</p>
            </div>
          </div>
          ...
          <div className="product-accordion">
            <div
              className={`accordion-tab ${activeTab === "description" ? "active" : ""}`}
            >
            ...
            <div
              className={`accordion-tab ${activeTab === "ingredients" ? "active" : ""}`}
            >
            ...
            <div
              className={`accordion-tab ${activeTab === "usage" ? "active" : ""}`}
            >
