    ...
    <div className="home-page fade-in">
        ...
        <div className="container hero-diag-grid">
          ...
          <div className="hero-diag-visual">
            <div className="diag-image-main">
              <img
                src={heroDiagImg.src || heroDiagImg}
                alt="Diagnostic beauté"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="triptych-grid-refined">
            <div className="triptych-card vibrant">
              <img
                src={triptyque1.src || triptyque1}
                alt={t("triptych_essential")}
            ...
            <div className="triptych-card minimalist">
              <img
                src={triptyque2.src || triptyque2}
                alt={t("triptych_essence")}
                className="triptych-img"
              />
              <div className="card-overlay">
            ...
            <div className="triptych-card lifestyle-reel">
              ...
              >
                <source
                  src="https://player.vimeo.com/external/517088497.hd.mp4?s=d405232d3265efc27242cedb6d3b41d2f8e1a1b1&profile_id=174"
                  type="video/mp4"
                />
            ...
            <div className="partners-title-row">
              <h2>
                ...
                <span className="highlight-text">
                  {t("partners_highlight")}
                </span>
              </h2>
              <a href="/shop" className="view-all-partners">
                {t("partners_view_all")}
              </a>
            </div>
          </div>
      ...
      <section className="framed-section-container incontournables">
        <div className="container">
          <div className="section-head">
            ...
            <a href="/shop" className="link-rose">
              {t("featured_view_all")} <ArrowRight size={14} />
            </a>
          </div>
          ...
          <div className="journal-grid">
            <article className="journal-card">
              ...
              <div className="journal-body">
                ...
                <a href="/blog/rituels-matin" className="link-rose">
            ...
            <article className="journal-card journal-card--accent">
              ...
              <div className="journal-body">
                ...
                <a href="/blog/tendances-maquillage" className="link-rose">
                  Lire l'article <ArrowRight size={14} />
                </a>
              </div>
            </article>
      ...
      <section className="promo-image-section fade-in">
        <div className="promo-image-overlay">
          <h2>
            {t("promo_title")} <em>{t("promo_highlight")}</em>
          </h2>
          <p>{t("promo_desc")}</p>
