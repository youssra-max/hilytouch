...
import { Store, User, MapPin, FileText, CreditCard, ShieldCheck, Upload, CheckCircle2 } from 'lucide-react';
    ...
    return (
      <div className="register-container fade-in">
        <div className="register-success">
          ...
          <p>Merci de vouloir rejoindre Hilytouch ! Votre demande d'inscription a bien été transmise à notre équipe. Vous recevrez un email de confirmation dès que votre compte aura été validé.</p>
  ...
  return (
    <div className="register-container fade-in">
      <div className="register-header">
        ...
        <p>Rejoignez la première marketplace de beauté et soins, et touchez des milliers de clients.</p>
      </div>
      ...
      <form className="register-form" onSubmit={handleSubmit}>
        ...
        <section className="form-section">
          ...
          <div className="form-group vendor-type-group">
            <label className="radio-label">
              <input type="radio" name="vendorType" value="marque" onChange={handleChange} required />
              <span>Marque Officielle (Entreprise)</span>
            </label>
            <label className="radio-label">
              <input type="radio" name="vendorType" value="artisan" onChange={handleChange} required />
          ...
          <div className="form-group">
            ...
            <input type="text" name="brandName" value={formData.brandName} onChange={handleChange} required placeholder="Ex: Maison Hily" />
          </div>

          <div className="form-group">
            <label>Description courte de la marque *</label>
            <textarea name="brandDescription" value={formData.brandDescription} onChange={handleChange} required placeholder="Présentez votre marque et vos produits en quelques lignes." rows="3"></textarea>
          </div>
        ...
        <section className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input type="email" name="email" value={formData.email} onChange={handleChange} required placeholder="contact@marque.com" />
            </div>
            <div className="form-group">
              <label>Numéro de Téléphone *</label>
              <input type="tel" name="phone" value={formData.phone} onChange={handleChange} required placeholder="05XX XX XX XX" />
            </div>
          </div>
        ...
        <section className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label>Wilaya *</label>
              <select name="wilaya_id" value={formData.wilaya_id} onChange={handleChange} required>
          ...
          <div className="form-group">
            ...
            <input type="text" name="address" value={formData.address} onChange={handleChange} required placeholder="Rue, Bâtiment..." />
          </div>
        </section>
        ...
        <section className="form-section">
          ...
          <div className="form-group">
            <label>Numéro de Registre de Commerce (RC) ou Carte Artisan *</label>
            <input type="text" name="legalNumber" value={formData.legalNumber} onChange={handleChange} required />
          </div>
        ...
        <section className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              <label>RIP / RIB *</label>
              <input type="text" name="rib" value={formData.rib} onChange={handleChange} required />
            </div>
            <div className="form-group">
        ...
        <section className="form-section terms-section">
          ...
          <label className="checkbox-label">
            ...
            <span>
              J'ai lu et j'accepte les <a href="/legal" className="terms-link" target="_blank" rel="noopener noreferrer">Conditions Générales de Vente et d'Utilisation</a> de la marketplace Hilytouch.
            </span>
          </label>
        </section>
